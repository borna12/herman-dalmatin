...
function stvori() {
    ...
    if (slika == '1.jpg') {
        ...
        opishr = "<p>By translating into Latin, Herman was opening the treasures of Arabic knowledge to Europe, created on the basis of two sources: ancient Greek and Eastern understandings. What Herman and his contemporaries translated in the 12th century was transmitted and spread in the schools of Western Europe, and influenced the development and direction of teaching and intellectual activity at the universities of Western Europe until the end of the Middle Ages. Also, it was the beginning of the creation of something qualitatively new, as well as part of the preparations that led to major conceptual changes in science and philosophy during the Renaissance, when the foundations of modern science and philosophy were established and shaped. However, the process of transfer, transformation and acceptance of knowledge and philosophical views is much more complex than it seems at first glance. In this process, in addition to the influence of Arabic and ancient Greek philosophies and sciences, there are also visible influences of various Eastern knowledge such as Persian, Indian and Chinese, which is also reflected in the works that Herman translated and wrote, thus transmitting them to the Latin-Christian West.</p>"
        opiseng = ""
        nazivhr = "Herman engaged in translation and scientific work in the translation centers along the Ebro River (Spain), during the period from 1138 to 1142. Then, returning to Europe from a study trip in Arab countries, he prepared about ten translations and compilations."
        naziveng = ""
    } else if (slika == '6.jpg') {
